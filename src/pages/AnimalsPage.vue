<template>
  <section class="page">
    ...
    <div class="grid">
      <GameCard v-for="it in animals" :key="it.id" :img="it.img" :emoji="it.emoji" :big="it.big" :active="activeId===it.id" @pick="pick(it)" />
    </div>
...
.choice img{width:92px;height:92px;object-fit:contain;filter:drop-shadow(0 18px 24px rgba(0,0,0,.18))}
